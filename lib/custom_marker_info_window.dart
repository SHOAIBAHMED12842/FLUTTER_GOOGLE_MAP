...
class _CustomMarkerInfoWindowScreenState extends State<CustomMarkerInfoWindowScreen> {
  ...
  final LatLng _latLng = const LatLng(24.84785,67.10000);
    ...
    for(int i = 0 ; i < images.length ; i++){
      ...
      if(i == 1 ){
        _markers.add(Marker(
            ...
            position: const LatLng(24.84785,67.15000),
            ...
            onTap: () {
              _customInfoWindowController.addInfoWindow!(
                ...
                const LatLng(24.84785,67.15000),
              );
            }
        ));
      }else {
        _markers.add( Marker(
            ...
            position: const LatLng(24.84785,67.10000),
            icon: BitmapDescriptor.fromBytes(markerIcon),
            onTap: () {
              _customInfoWindowController.addInfoWindow!(
                  Container(
                ...
                const LatLng(24.84785,67.10000),
              );
            }
        ));
      }
  ...
  Widget build(BuildContext context) {
   // loadData() ;
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Map Custom Info Window'),
